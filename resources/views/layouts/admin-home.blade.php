...
<html lang="en">
	<!--begin::Head-->
	<head><base href=""> 
		<title>DevQuire Accounting</title>
		...
		<link rel="stylesheet" href="/public/metronic/css/style.css')}}">
		<!--begin::Fonts-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Page Vendor Stylesheets(used by this page)-->
		<link href="{{url('/public/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
...
-->
		...
		<script src="{{url('/public/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{url('/public/metronic/assets/js/custom/widgets.js')}}"></script>
		<script src="{{url('/public/metronic/assets/js/custom/apps/chat/chat.js')}}"></script>
		<script src="{{url('public/metronic/assets/js/custom/modals/create-app.js')}}"></script>
		<script src="{{url('/public/metronic/assets/js/custom/modals/upgrade-plan.js')}}"></script>
